    ...
    switch(media_ptr -> fx_media_driver_request)
    {
        ...
        case FX_DRIVER_READ:
        {
            ...
            while (count)
            {
                ...
                status =  _lx_nand_flash_sector_read(&g_lx_nandflash, logical_sector, buffer);
        ...
        case FX_DRIVER_WRITE:
        {
            ...
            while (count)
            {
                ...
                status =  _lx_nand_flash_sector_write(&g_lx_nandflash, logical_sector, buffer);
        ...
        case FX_DRIVER_RELEASE_SECTORS:
        {
            ...
            while (count)
            {
                ...
                status =  _lx_nand_flash_sector_release(&g_lx_nandflash, logical_sector);
        ...
        case FX_DRIVER_INIT:
        {
            ...
            status = lx_nand_flash_open_with_format();
            if (status != LX_SUCCESS) {
                /* Return an I/O error to FileX.  */
                media_ptr -> fx_media_driver_status =  FX_IO_ERROR;
                return;
        ...
        case FX_DRIVER_UNINIT:
        {
            ...
            status =  _lx_nand_flash_close(&g_lx_nandflash);
        ...
        case FX_DRIVER_BOOT_READ:
        {
            ...
            status =  _lx_nand_flash_sector_read(&g_lx_nandflash, 0, (UCHAR *) media_ptr -> fx_media_driver_buffer);
        ...
        case FX_DRIVER_BOOT_WRITE:
        {
            ...
            status =  _lx_nand_flash_sector_write(&g_lx_nandflash, 0, (UCHAR *) media_ptr -> fx_media_driver_buffer);
